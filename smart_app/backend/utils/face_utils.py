...
class FaceRecognitionSystem:
    ...
    def extract_face_encoding(self, image: np.ndarray) -> list:
        ...
        try:
            ...
            # Find face locations
            face_locations = face_utils.face_locations(rgb_image)
            ...
            face_encodings = face_utils.face_encodings(rgb_image, face_locations)
    ...
    def verify_face_match(
        self, stored_encoding: list, current_image: np.ndarray, tolerance: float = 0.6
    ) -> dict:
        ...
        try:
            ...
            # Compare faces
            distance = face_utils.face_distance(
                [stored_encoding_np], current_encoding_np
            )[0]
